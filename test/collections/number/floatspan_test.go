...
func createFloatSpan_inspan() *gomeos.FloatSpan {
	return gomeos.NewFloatSpan("[1.1, 3.3]")
}

func createFloatSpan_inspan2() *gomeos.FloatSpan {
	return gomeos.NewFloatSpan("[2.2, 4.4]")
}

func TestNewFloatSpan(t *testing.T) {
	g_fs := createFloatSpan_inspan()
...
func TestFloatSpanDistance(t *testing.T) {
	g_fs := createFloatSpan_inspan()
	g_fs_2 := createFloatSpan_inspan2()
...
func TestFloatSpanUnion(t *testing.T) {
	...
	assert.Equal(t, res.FloatSpanSetOut(5), "{[1.1, 3.3]}")
	assert.Equal(t, err, nil)
}
